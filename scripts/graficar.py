...
dataset = dataframe_original_limpio().head(500)
...
def graficar():
    ...
    axes[0, 1].set(title="Distribución de los valores de datos", xlim=(0, 2200))
    axes[1, 0].set(title="Cantidad de trabajos por unidades", ylim=(0, 450))
